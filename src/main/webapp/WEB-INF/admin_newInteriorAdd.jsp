...
<head>
<meta charset="UTF-8">
<title>유림 더 숲 인테리어 - 관리자 신축인테리어 추가</title>
</head>
<body>
<% 
...
%>
	...
	<div class="subnewinterior-container">
		...
		<form action="admin_newInteriorAddOk.do" method="post" enctype="multipart/form-data">
			...
			<input type="submit" value="추가" class="btn_add" onclick="alert('신축 인테리어 목록이 추가되었습니다.');">
		</form>
